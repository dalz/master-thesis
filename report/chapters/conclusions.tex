...
Here we elaborate on the experience of using Katamaran, discuss the next steps toward a more comprehensive verification of the \msp, and briefly go over other approaches to ISA verification.
