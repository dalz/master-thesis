...
A predicate definition consists of name, argument types, \emph{duplicability} and \emph{preciseness}. \Cref{lst:ptstomem} shows the resource of memory locations, \coq{ptstomem}. We also define a notation \coq{l m↦ v} for easier use of the predicate and resemblance to the built-in points-to for registers.
