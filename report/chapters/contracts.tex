...
\begin{itemize}
\item We define contracts for complex function that are called multiple times. Once a contract for a function is defined, it will be used in place of symbolically executing the body at each call.
...
In this section we present our proof of the universal contract for the \msp in a top-down fashion, starting from the security guarantee we ended up verifying and progressively showing the auxilliary specifications we had to prove to get there.
