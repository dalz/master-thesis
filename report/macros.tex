...
\newcommand*{\hex}[1]{\texttt{0x\MakeUppercase{#1}}}
...
\newcommand*{\hoared}[2]{\left\{#1\right\}\,#2}
...
\newcounter{mycstepcnt}[cstepcnt]
\renewcommand{\startcstep}{\stepcounter{cstepcnt}}
\makeatletter
\newcommand*{\circdef}[1]{
  \refstepcounter{mycstepcnt}%
  \Circled{\arabic{mycstepcnt}}%
  \ltx@label{circ:#1}}
\makeatother
